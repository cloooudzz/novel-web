...
import { ref, provide, computed, onMounted, onUnmounted, watch } from 'vue'  // 添加 computed
...
const syncUserInfoFromStorage = () => {
  ...
  console.log('同步用户信息 - user:', user, 'avatar:', avatar, 'userId:', userId)
